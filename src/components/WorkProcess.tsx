...
const STEPS = [
    {
        id: "01",
        title: "Estimate Your Monthly Fee",
        desc: "Use our pricing calculator to get an instant estimate based on your business activity and service needs.",
        icon: (
    ...
    {
        id: "02",
        title: "Connect with Your Virtual CFO",
        desc: "Discuss your business model, financial processes, and requirements to refine your quotation.",
        icon: (
    ...
    },
    {
        ...
        desc: "We review your books, accounting systems, and financial records to align services with your actual needs.",
        icon: (
    ...
    {
        id: "04",
        title: "Finance Team Onboarded",
        desc: "Your Virtual CFO and finance team begin managing your finance function, reporting, compliance, and advisory.",
        active: true,
        icon: (
