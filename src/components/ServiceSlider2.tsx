...
const SERVICES = [
  ...
  { title: ["AI CFO", "Portal"], desc: "Proprietary access to real-time financial insights and AI-powered intelligence for decision support.", img: serviceImg5, icon: ICON_PATHS.icon5 },
