...
import popupImg from "@/assets/newsletter.jpg"
                ...
                <>
                    ...
                    />
                            ...
                            <div className="relative w-full max-w-[900px]">
                                ...
                                {/* CLOSE BUTTON — NOT INSIDE SCROLL */}
                                <button
                                onClick={onClose}
                                aria-label="Close"
                                ...
                                <div className="w-full md:w-[50%] shrink-0">
                                    ...
                                    className="
                                        ...
                                        h-[200px] md:h-full
                                        rounded-t-[20px] md:rounded-l-[20px]
                                        md:rounded-t-none
                                    "
                                    />
                                </div>
                                ...
                                <div
                                    ...
                                    px-3 md:px-12 py-10
                                    flex-1 bg-[#f6f7f4]
                                    rounded-b-[20px] md:rounded-r-[20px]
                                    md:rounded-b-none
                                    "
                                >
                                    ...
                                    {/* Social icons */}
                                    <div className="flex items-center gap-8 mt-5 justify-center md:justify-start">
                                        {[
                                            {
                                                label: "Twitter / X",
                                                icon: (
