...
export default function WhoWeHelp() {
  ...
  return (
    <>
      <Header />
      <PageHero image={heroImage} eyebrow="UK and US Businesses" title="Built for Owners Who Need More From Finance" description="Mavens Advisor supports founders and leadership teams that want to retain more profit, understand cash, reduce financial administration and make important decisions with CFO-level guidance." primaryLabel="Tell Us What You Need" primaryTo="/contact" />
