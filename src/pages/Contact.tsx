      ...
      <main className="bg-[#f6f7f4] py-[80px] md:py-[120px]">
        <div className="container">
          <div className="grid grid-cols-1 gap-7 lg:grid-cols-2">
            <section className="rounded-[30px] bg-white p-[35px] md:p-[50px]">
              ...
              <p className="mt-5 text-[17px] leading-[1.75] text-[#6b6b6b]">For business owners who need Finance System Setup, Finance Operations, Financial Reporting and Forecasting, UK or US Tax and Compliance, Strategic Financial Advisory, or a broader Virtual CFO engagement.</p>
              <Link to="/get-a-quote" className="mt-8 inline-flex items-center gap-3 rounded-[14px] bg-primary-gradient px-7 py-4 font-semibold">Get My Tailored Quote <ArrowRight size={18} /></Link>
            </section>
            <section className="rounded-[30px] bg-black p-[35px] text-white md:p-[50px]">
              ...
              <p className="mt-5 text-[17px] leading-[1.75] text-white/70">For teams that want to reduce repetitive accounting, tax or compliance administration while retaining human review and control.</p>
              <Link to="/automation-assessment" className="mt-8 inline-flex items-center gap-3 rounded-[14px] bg-primary-gradient px-7 py-4 font-semibold text-black">Assess My Workflow <ArrowRight size={18} /></Link>
            </section>
          </div>
